...
export default function Footer() {
  return (
    <footer id="footer" className="bg-foreground text-background">
      <div className="w-full max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 py-8 md:py-10 lg:py-14 xl:py-16 2xl:py-20">
        {/* Mobile Layout (< 640px) */}
